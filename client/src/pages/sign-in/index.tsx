        ...
        <div className=' bg-transparent/30 md:bg-transparent/90 w-[360px] md:w-[450px] px-8 rounded-md z-10'>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className='w-full'>
                <div className='relative h-10 w-full min-w-[200px]'>
                  <input
                    ...
                    className='peer h-full w-full  rounded-[7px]  !border  !border-gray-300 border-t-transparent bg-transparent bg-white bg-opacity-0 px-3 py-2.5 font-sans text-sm font-normal text-white  shadow-lg shadow-gray-900/5 outline outline-0 ring-4 ring-transparent transition-all placeholder:text-gray-500 placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2  focus:!border-gray-900 focus:border-t-transparent focus:!border-t-gray-900 focus:outline-0 focus:ring-gray-900/10 disabled:border-0 disabled:bg-blue-gray-50'
                    {...register('email')}
                  />
              ...
              <div className='w-full'>
                <div className='relative h-10 w-full min-w-[200px]'>
                  <input
                    ...
                    className='peer h-full w-full rounded-[7px]  !border  !border-gray-300 border-t-transparent bg-transparent bg-none bg-opacity-0 px-3 py-2.5 font-sans text-sm font-normal text-white  shadow-lg shadow-gray-900/5 outline outline-0 ring-4 ring-transparent transition-all placeholder:text-gray-500 placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2  focus:!border-gray-900 focus:border-t-transparent focus:!border-t-gray-900 focus:outline-0 focus:ring-gray-900/10 disabled:border-0 disabled:bg-blue-gray-50'
                    {...register('password')}
                  />
            ...
            <div className='flex gap-8 items-center mb-6'>
              <p
                className='text-[#5264d0] text-center text-[14px] hover:cursor-pointer'
